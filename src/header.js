...
export default function Header() {
  ...
  const scrollToAbout = (e) => {
    e.preventDefault(); // Prevent default link behavior
    window.scrollTo({
      top: window.innerWidth <= 767 ? 500 : 800, // Adjust for mobile vs desktop
      behavior: 'smooth'
    });
    closeMenu();
  };
  ...
  const scrollToSkills = (e) => {
    e.preventDefault(); // Prevent default link behavior
    window.scrollTo({
      top: window.innerWidth <= 767 ? 1850 : 1650,
      behavior: 'smooth'
    });
    closeMenu();
  };
  ...
  const scrollToProjects = (e) => {
    e.preventDefault(); // Prevent default link behavior
    window.scrollTo({
      top: window.innerWidth <= 767 ? 3500 : 3250,
      behavior: 'smooth'
    });
    closeMenu();
  };
  ...
  const scrollToContact = (e) => {
    e.preventDefault(); // Prevent default link behavior
    window.scrollTo({
      top: window.innerWidth <= 767 ? 4700 : 4500,
      behavior: 'smooth'
    });
    closeMenu();
  };
